...
class modifyRecord(object):
    ...
    def modify(self,record1=None):
        ...
        if not record1 == None:
            self.old = record1.copy()
            self.new = record1.copy()
...
the new value of that field.')
        ...
        #print 'record as in the function modify()',self.new

        #modifiedRecord = self.new.copy()        
...
def modRec(thisRec):
    ...
    '''this rec is the string that consists of the present record
